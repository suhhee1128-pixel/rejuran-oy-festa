...
`;function yl(){let e=document.createElement(`canvas`);e.width=128,e.height=256;let t=e.getContext(`2d`);t.shadowColor=`rgba(255,255,255,0.72)`,t.shadowBlur=28,t.fillStyle=`rgba(255,255,255,0.58)`,t.beginPath(),t.roundRect(43,50,42,156,21),t.fill(),t.shadowBlur=14,t.fillStyle=`#ffffff`,t.beginPath(),t.roundRect(45,52,38,152,19),t.fill();let n=new Oi(e);return n.colorSpace=nt,n.needsUpdate=!0,n}function bl({chat:e=!1,origin:t=`home`,still:n=!1,style:r}){return(0,Z.jsx)(`div`,{className:`v2-fluid-bg v2-fluid-bg--${t}${e?` v2-fluid-bg-chat`:``}${n?` v2-fluid-bg--still`:``}`,style:r,"aria-hidden":`true`,children:!n&&(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(`div`,{className:`v2-fluid-sheen`}),(0,Z.jsxs)(`div`,{className:`v2-wave-field`,children:[(0,Z.jsx)(`span`,{className:`v2-idle-wave v2-idle-wave-1`}),(0,Z.jsx)(`span`,{className:`v2-idle-wave v2-idle-wave-2`}),(0,Z.jsx)(`span`,{className:`v2-idle-wave v2-idle-wave-3`}),(0,Z.jsx)(`span`,{className:`v2-idle-wave v2-idle-wave-4`})]})]})})}function xl({className:e=``,alt:t=``}){return(0,Z.jsx)(`video`,{className:`blob-video${e?` ${e}`:``}`,src:ul,poster:ll,"aria-label":t,autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:`auto`})}function Sl({className:e=``,alt:t=``}){let n=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let e=n.current;if(!e)return;let t=new Pn,r=new ba(28,1,.1,100);r.position.set(0,0,9.6);let i=new il({alpha:!0,antialias:!0,powerPreference:`high-performance`});i.setClearColor(0,0),i.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),i.outputColorSpace=nt,e.appendChild(i.domElement);let a=new Tn;a.scale.set(1,1,1),t.add(a);let o=new wa(16777215,1.35);t.add(o);let s=new Ca(16777215,1.9);s.position.set(-2.8,3.6,4.8),t.add(s);let c=new Ca(16777215,1.1);c.position.set(3.2,2.4,3.6),t.add(c);let l=new sl(2.18,2.18,2.18,32,.74),u=l.attributes.position.array.slice(),d=new Hi({vertexShader:_l,fragmentShader:vl}),f=new gi(l,d);f.scale.set(1,1,1),a.add(f);let p=yl(),m=new Pr({map:p,transparent:!0,opacity:.96,depthWrite:!1,depthTest:!0,blending:2}),h=new Jr(m);h.position.set(-.39,-.02,1.18),h.scale.set(.38,.58,1),a.add(h);let g=new Jr(m);g.position.copy(h.position),g.position.x=.39,g.scale.copy(h.scale),a.add(g);let _=()=>{let t=e.clientWidth||194,n=e.clientHeight||197;i.setSize(t,n,!1),r.aspect=t/n,r.updateProjectionMatrix()};_();let v=new ResizeObserver(_);v.observe(e);let y=performance.now(),b=0,x=1.8,S=e=>e*e*(3-2*e),C=(e,t,n)=>Math.max(0,1-Math.abs(e-t)/n),w=0,T=()=>{let e=(performance.now()-y)*.001,n=l.attributes.position;for(let t=0;t<n.count;t+=1){let r=t*3,i=u[r],a=u[r+1],o=u[r+2],s=1+Math.sin(i*3.1+e*1.35)*.01+Math.sin(a*4.4+e*1.05)*.008+Math.sin(o*5.3+e*1.18)*.006;n.setXYZ(t,i*s,a*s,o*s)}n.needsUpdate=!0,l.computeVertexNormals(),!b&&e>=x&&(b=e);let o=0;b&&(o=Math.min((e-b)/1.85,1),o>=1&&(b=0,x=e+2.3+Math.random()*3.2,o=0));let s=Math.sin(e*1.35)*.085,c=b?0:Math.sin(e*1.05)*.018,d=b?Math.sin(o*Math.PI):0,f=b?Math.sin(C(o,.93,.07)*Math.PI)*.035:0,p=b?d*.54+f:0,h=b?S(o)*Math.PI*2:0;a.scale.set(1,1,1);let g=h+c;m.opacity=.96*S(Math.min(Math.max(0,Math.cos(g))*1.35,1)),a.rotation.y=g,a.rotation.x=Math.sin(e*.9)*.02-d*.035,a.position.y=-.12+s+p,i.render(t,r),w=requestAnimationFrame(T)};return T(),()=>{cancelAnimationFrame(w),v.disconnect(),e.removeChild(i.domElement),l.dispose(),d.dispose(),p.dispose(),m.dispose(),i.dispose()}},[]),(0,Z.jsx)(`div`,{ref:n,className:`home-blob-3d${e?` ${e}`:``}`,role:`img`,"aria-label":t})}function Cl(e){let t=document.querySelector(`.portrait-layout`);if(!e||!t)return null;let n=t.getBoundingClientRect(),r=e.getBoundingClientRect(),i=n.width/1080||1;return{left:(r.left-n.left)/i,top:(r.top-n.top)/i,width:r.width/i,height:r.height/i}}function wl({children:e,origin:t}){let n=(0,_.useRef)(null),[r,i]=(0,_.useState)(null);return(0,_.useEffect)(()=>{if(!t||!n.current)return;let e=Cl(n.current);if(!e)return;let r=t.left+t.width/2,a=t.top+t.height/2,o=e.left+e.width/2,s=e.top+e.height/2;i({"--answer-fly-x":`${r-o}px`,"--answer-fly-y":`${a-s}px`})},[t,e]),(0,Z.jsx)(`div`,{ref:n,className:`v2-bubble v2-bubble-user v2-survey-followup-user${t?` v2-answer-fly-in`:``}${r?` v2-answer-fly-ready`:``}`,style:r||void 0,children:e})}var Tl=[{icon:hl,text:`What is PDRN?`,screen:`pdrn`},{icon:ml,text:`What makes REJURAN's PDRN
