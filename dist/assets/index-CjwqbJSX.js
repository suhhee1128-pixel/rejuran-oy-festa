...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function go(e,t,n){let r=new Float32Array(no),i=new W(0,1,0);return new Hi({name:`SphericalGaussianBlur`,defines:{n:no,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:yo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _o(){return new Hi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:yo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vo(){return new Hi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:yo(),fragmentShader:`
	...
	`}var bo=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Di(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function yl(){let e=document.createElement(`canvas`);e.width=128,e.height=256;let t=e.getContext(`2d`);t.shadowColor=`rgba(255,255,255,0.72)`,t.shadowBlur=28,t.fillStyle=`rgba(255,255,255,0.58)`,t.beginPath(),t.roundRect(43,50,42,156,21),t.fill(),t.shadowBlur=14,t.fillStyle=`#ffffff`,t.beginPath(),t.roundRect(45,52,38,152,19),t.fill();let n=new Oi(e);return n.colorSpace=nt,n.needsUpdate=!0,n}function bl({chat:e=!1,origin:t=`home`,still:n=!1,style:r}){return(0,Z.jsx)(`div`,{className:`v2-fluid-bg v2-fluid-bg--${t}${e?` v2-fluid-bg-chat`:``}${n?` v2-fluid-bg--still`:``}`,style:r,"aria-hidden":`true`,children:!n&&(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(`div`,{className:`v2-fluid-sheen`}),(0,Z.jsxs)(`div`,{className:`v2-wave-field`,children:[(0,Z.jsx)(`span`,{className:`v2-idle-wave v2-idle-wave-1`}),(0,Z.jsx)(`span`,{className:`v2-idle-wave v2-idle-wave-2`}),(0,Z.jsx)(`span`,{className:`v2-idle-wave v2-idle-wave-3`}),(0,Z.jsx)(`span`,{className:`v2-idle-wave v2-idle-wave-4`})]})]})})}function xl({className:e=``,alt:t=``}){return(0,Z.jsx)(`video`,{className:`blob-video${e?` ${e}`:``}`,src:ul,poster:ll,"aria-label":t,autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:`auto`})}function Sl({className:e=``,alt:t=``}){let n=(0,_.useRef)(null),[r,i]=(0,_.useState)(1);return(0,_.useEffect)(()=>{let e=n.current;if(!e)return;let t=new Pn,r=new ba(28,1,.1,100);r.position.set(0,0,9.6);let a=new il({alpha:!0,antialias:!0,powerPreference:`high-performance`});a.setClearColor(0,0),a.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),a.outputColorSpace=nt,e.appendChild(a.domElement);let o=new Tn;o.scale.set(1,1,1),t.add(o);let s=new wa(16777215,1.35);t.add(s);let c=new Ca(16777215,1.9);c.position.set(-2.8,3.6,4.8),t.add(c);let l=new Ca(16777215,1.1);l.position.set(3.2,2.4,3.6),t.add(l);let u=new sl(2.18,2.18,2.18,32,.74),d=u.attributes.position.array.slice(),f=new Hi({vertexShader:_l,fragmentShader:vl}),p=new gi(u,f);p.scale.set(1,1,1),o.add(p);let m=yl(),h=new Pr({map:m,transparent:!0,opacity:.96,depthWrite:!1,depthTest:!0,blending:2}),g=new Jr(h);g.position.set(-.39,-.02,1.18),g.scale.set(.38,.58,1),o.add(g);let _=new Jr(h);_.position.copy(g.position),_.position.x=.39,_.scale.copy(g.scale),o.add(_);let v=()=>{let t=e.clientWidth||194,n=e.clientHeight||197;a.setSize(t,n,!1),r.aspect=t/n,r.updateProjectionMatrix()};v();let y=new ResizeObserver(v);y.observe(e);let b=performance.now(),x=0,S=1.8,C=e=>e*e*(3-2*e),w=(e,t,n)=>Math.max(0,1-Math.abs(e-t)/n),T=0,E=()=>{let e=(performance.now()-b)*.001,n=u.attributes.position;for(let t=0;t<n.count;t+=1){let r=t*3,i=d[r],a=d[r+1],o=d[r+2],s=1+Math.sin(i*3.1+e*1.35)*.01+Math.sin(a*4.4+e*1.05)*.008+Math.sin(o*5.3+e*1.18)*.006;n.setXYZ(t,i*s,a*s,o*s)}n.needsUpdate=!0,u.computeVertexNormals(),!x&&e>=S&&(x=e,i(e=>e+1));let s=0;x&&(s=Math.min((e-x)/1.85,1),s>=1&&(x=0,S=e+2.3+Math.random()*3.2,s=0));let c=Math.sin(e*1.35)*.085,l=x?0:Math.sin(e*1.05)*.018,f=x?Math.sin(s*Math.PI):0,p=x?Math.sin(w(s,.93,.07)*Math.PI)*.035:0,m=x?f*.54+p:0,g=x?C(s)*Math.PI*2:0;o.scale.set(1,1,1);let _=g+l;h.opacity=.96*C(Math.min(Math.max(0,Math.cos(_))*1.35,1)),o.rotation.y=_,o.rotation.x=Math.sin(e*.9)*.02-f*.035,o.position.y=-.12+c+m,a.render(t,r),T=requestAnimationFrame(E)};return E(),()=>{cancelAnimationFrame(T),y.disconnect(),e.removeChild(a.domElement),u.dispose(),f.dispose(),m.dispose(),h.dispose(),a.dispose()}},[]),(0,Z.jsx)(`div`,{ref:n,className:`home-blob-3d${e?` ${e}`:``}`,role:`img`,"aria-label":t,children:(0,Z.jsx)(`span`,{className:`home-blob-magic-trail`,"aria-hidden":`true`,children:Array.from({length:28},(e,t)=>(0,Z.jsx)(`i`,{},t))},r)})}function Cl(e){let t=document.querySelector(`.portrait-layout`);if(!e||!t)return null;let n=t.getBoundingClientRect(),r=e.getBoundingClientRect(),i=n.width/1080||1;return{left:(r.left-n.left)/i,top:(r.top-n.top)/i,width:r.width/i,height:r.height/i}}function wl({children:e,origin:t}){let n=(0,_.useRef)(null),[r,i]=(0,_.useState)(null);return(0,_.useEffect)(()=>{if(!t||!n.current)return;let e=Cl(n.current);if(!e)return;let r=t.left+t.width/2,a=t.top+t.height/2,o=e.left+e.width/2,s=e.top+e.height/2;i({"--answer-fly-x":`${r-o}px`,"--answer-fly-y":`${a-s}px`})},[t,e]),(0,Z.jsx)(`div`,{ref:n,className:`v2-bubble v2-bubble-user v2-survey-followup-user${t?` v2-answer-fly-in`:``}${r?` v2-answer-fly-ready`:``}`,style:r||void 0,children:e})}var Tl=[{icon:hl,text:`What is PDRN?`,screen:`pdrn`},{icon:ml,text:`What makes REJURAN's PDRN
different from other brands?`,screen:`pdrn2`}],El=`PDRN (Polydeoxyribonucleotide) is a DNA-derived bioactive ingredient extracted from salmon.

It activates tissue repair, stimulates collagen production, and supports deep skin regeneration — making it the core of REJURAN's science.`,Dl=`REJURAN uses pharmaceutical-grade PDRN with a clinically verified molecular weight optimized for skin absorption.

Unlike other brands that use generic DNA extracts, REJURAN's PDRN is standardized through a patented purification process — ensuring consistent potency, safety, and regenerative efficacy in every product.`;function Ol({onBack:e}){return(0,Z.jsxs)(`header`,{className:`v2-header`,onClick:e,style:{cursor:e?`pointer`:`default`},children:[(0,Z.jsx)(`img`,{src:fl,alt:`menu`,className:`v2-header-icon-left`}),(0,Z.jsxs)(`div`,{className:`v2-header-center`,children:[(0,Z.jsxs)(`div`,{className:`v2-title-row`,children:[(0,Z.jsx)(`span`,{className:`v2-title`,children:`Chat REJURAN 8.1`}),(0,Z.jsx)(`img`,{src:`/mdi_expand-more.png`,alt:``,className:`v2-chevron`})]}),(0,Z.jsx)(`span`,{className:`v2-subtitle`,children:`OLIVE YOUNG FESTA 2026`})]}),(0,Z.jsx)(`img`,{src:pl,alt:`chat`,className:`v2-header-icon-right`})]})}function kl({question:e,answer:t,onBack:n,onNext:r,recommendation:i,variant:a=`default`}){let[o,s]=(0,_.useState)(!1),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)(!1),[f,p]=(0,_.useState)(`loading`),[m,h]=(0,_.useState)(``),[g,v]=(0,_.useState)(!1),[y,b]=(0,_.useState)(!1),[x,S]=(0,_.useState)(``),C=m.length>=t.length;return(0,_.useEffect)(()=>{s(!1),l(!1),d(!1),p(`loading`),h(``);let e=setTimeout(()=>s(!0),180),t=setTimeout(()=>l(!0),520),n=setTimeout(()=>d(!0),860);return()=>{clearTimeout(e),clearTimeout(t),clearTimeout(n)}},[e,t]),(0,_.useEffect)(()=>{if(!u)return;p(`loading`),h(``);let e=setTimeout(()=>p(`typing`),900);return()=>clearTimeout(e)},[u,e,t]),(0,_.useEffect)(()=>{if(!u||f!==`typing`||C)return;let e=setTimeout(()=>{h(t.slice(0,m.length+1))},28);return()=>clearTimeout(e)},[u,f,m,C,t]),(0,_.useEffect)(()=>{v(!1),b(!1),S(``)},[e,t]),(0,_.useEffect)(()=>{if(!C||!i)return;let e=setTimeout(()=>v(!0),420);return()=>clearTimeout(e)},[C,i]),(0,_.useEffect)(()=>{if(!g)return;let e=setTimeout(()=>b(!0),180);return()=>clearTimeout(e)},[g]),(0,Z.jsxs)(`div`,{className:`v2-chat-screen v2-chat-screen--${a}`,children:[(0,Z.jsx)(bl,{chat:!0,origin:`center`}),(0,Z.jsx)(Ol,{onBack:n}),(0,Z.jsx)(`div`,{className:`v2-deco v2-deco-left`,children:(0,Z.jsx)(`img`,{src:gl,alt:``})}),(0,Z.jsx)(`div`,{className:`v2-deco v2-deco-right`,children:(0,Z.jsx)(`img`,{src:gl,alt:``,style:{transform:`scaleX(-1)`}})}),o&&(0,Z.jsx)(`div`,{className:`v2-bubble v2-bubble-user v2-chat-sequence-in`,children:e}),c&&(0,Z.jsx)(`div`,{className:`v2-chat-blob-wrap v2-chat-sequence-in`,children:(0,Z.jsx)(xl,{alt:`REJURAN character`})}),u&&(f===`loading`?(0,Z.jsxs)(`div`,{className:`v2-bubble v2-bubble-typing v2-chat-sequence-in`,children:[(0,Z.jsx)(`span`,{className:`v2-dot`}),(0,Z.jsx)(`span`,{className:`v2-dot`}),(0,Z.jsx)(`span`,{className:`v2-dot`})]}):(0,Z.jsxs)(`div`,{className:`v2-bubble v2-bubble-answer v2-chat-answer v2-chat-sequence-in`,children:[m,!C&&(0,Z.jsx)(`span`,{className:`v2-cursor`})]})),g&&(0,Z.jsxs)(`div`,{className:`v2-chat-recommendation`,children:[(0,Z.jsxs)(`div`,{className:`v2-chat-recommendation-bubble`,children:[(0,Z.jsx)(`p`,{className:`v2-chat-recommendation-copy`,children:`Want to explore this too?`}),(0,Z.jsx)(`p`,{className:`v2-chat-recommendation-question`,children:i.question})]}),y&&(0,Z.jsxs)(`div`,{className:`v2-chat-recommendation-actions`,children:[(0,Z.jsxs)(`button`,{type:`button`,className:`v2-chat-choice-btn${x===`yes`?` v2-chat-choice-selected`:``}`,onClick:()=>S(`yes`),children:[(0,Z.jsx)(`span`,{className:`v2-chat-choice-radio`}),(0,Z.jsx)(`span`,{children:`Yes`})]}),(0,Z.jsxs)(`button`,{type:`button`,className:`v2-chat-choice-btn${x===`no`?` v2-chat-choice-selected`:``}`,onClick:()=>S(`no`),children:[(0,Z.jsx)(`span`,{className:`v2-chat-choice-radio`}),(0,Z.jsx)(`span`,{children:`No`})]})]})]}),y&&x&&(0,Z.jsx)(`button`,{type:`button`,className:`v2-next-btn v2-chat-recommendation-next`,onClick:()=>{if(x===`yes`){i.onYes();return}x===`no`&&r()},children:`Next →`}),C&&!i&&(0,Z.jsx)(`button`,{type:`button`,className:`v2-next-btn`,onClick:r,children:`Next →`}),(0,Z.jsx)(`div`,{className:`v2-logo-wrap`,children:(0,Z.jsx)(`img`,{src:dl,alt:`REJURAN COSMETICS`,className:`v2-logo`})})]})}function Al({onOk:e}){return(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(bl,{origin:`great`}),(0,Z.jsx)(Ol,{}),(0,Z.jsx)(`div`,{className:`v2-deco v2-deco-left`,children:(0,Z.jsx)(`img`,{src:gl,alt:``})}),(0,Z.jsx)(`div`,{className:`v2-deco v2-deco-right`,children:(0,Z.jsx)(`img`,{src:gl,alt:``,style:{transform:`scaleX(-1)`}})}),(0,Z.jsx)(`div`,{className:`v2-great-text`,children:(0,Z.jsxs)(`p`,{className:`v2-great-title`,children:[(0,Z.jsx)(`span`,{className:`v2-great-first-line`,children:`Great!`}),(0,Z.jsx)(`br`,{}),`Now let's find your`,(0,Z.jsx)(`br`,{}),`perfect match together!`]})}),(0,Z.jsx)(`button`,{type:`button`,className:`v2-ok-btn`,onClick:e,children:`OK!`}),(0,Z.jsx)(`div`,{className:`v2-logo-wrap`,children:(0,Z.jsx)(`img`,{src:dl,alt:`REJURAN COSMETICS`,className:`v2-logo`})})]})}var jl=[`Normal`,`Sensitive`,`Oily`,`Combination`,`Dry`,`Not sure`],Ml=`How would you describe your skin?`;function Nl({onNext:e,onBack:t}){let[n,r]=(0,_.useState)(null),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(``),[c,l]=(0,_.useState)(0),u=(0,_.useRef)({}),d=o.length>=33;return(0,_.useEffect)(()=>{let e=setTimeout(()=>a(!0),750);return()=>clearTimeout(e)},[]),(0,_.useEffect)(()=>{if(!i||d)return;let e=setTimeout(()=>{s(Ml.slice(0,o.length+1))},36);return()=>clearTimeout(e)},[i,o,d]),(0,_.useEffect)(()=>{if(!d)return;let e=jl.map((e,t)=>setTimeout(()=>l(t+1),300+t*140));return()=>e.forEach(clearTimeout)},[d]),(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(bl,{chat:!0,origin:`center`}),(0,Z.jsx)(Ol,{onBack:t}),(0,Z.jsx)(`div`,{className:`v2-quiz-question${i?` v2-quiz-visible`:``}`,children:(0,Z.jsxs)(`div`,{className:`v2-quiz-q-bubble-wrap`,children:[(0,Z.jsxs)(`p`,{className:`v2-quiz-q-text`,children:[o,!d&&(0,Z.jsx)(`span`,{className:`v2-cursor`})]}),d&&(0,Z.jsx)(`span`,{className:`v2-q-hint`,children:`SELECT ONLY 1`})]})}),(0,Z.jsx)(`div`,{className:`v2-quiz-grid`,children:jl.map((e,t)=>(0,Z.jsxs)(`button`,{ref:t=>{u.current[e]=t},type:`button`,className:`v2-quiz-opt${n===e?` v2-quiz-opt-selected`:``}${c>t?` v2-quiz-opt-visible`:``}`,onClick:()=>r(e),children:[(0,Z.jsx)(`span`,{className:`v2-quiz-radio${n===e?` v2-quiz-radio-on`:``}`}),(0,Z.jsx)(`span`,{children:e})]},e))}),c>=jl.length&&(0,Z.jsxs)(`div`,{className:`v2-quiz-actions`,children:[(0,Z.jsx)(`button`,{type:`button`,className:`v2-back-btn`,onClick:t,children:`Back`}),(0,Z.jsx)(`button`,{type:`button`,disabled:!n,className:`v2-card-next-btn${n?` v2-card-next-btn-active`:``}`,onClick:()=>n&&e(n,Cl(u.current[n])),children:`Next →`})]}),(0,Z.jsx)(`div`,{className:`v2-logo-wrap`,children:(0,Z.jsx)(`img`,{src:dl,alt:`REJURAN COSMETICS`,className:`v2-logo`})})]})}var Pl={Normal:`Great! Even balanced skin benefits from consistent care.`,Sensitive:`Got it! Sensitive skin needs gentle, calming ingredients.`,Oily:`Understood! Oily skin thrives with lightweight, balancing products.`,Combination:`Makes sense! Combination skin needs targeted zone care.`,Dry:`Got it! Dry skin craves deep hydration and repair.`,"Not sure":`No worries — let's figure out what your skin needs together!`},Q=[`Visible pores or excess oil`,`Dullness or uneven texture`,`Dryness, tightness or irritation`,`Loss of firmness or elasticity`],$={"Visible pores or excess oil":`Got it! Your skin needs pore refinement and sebum-balancing care.`,"Dullness or uneven texture":`I see! Your skin is calling for brightening and gentle resurfacing.`,"Dryness, tightness or irritation":`Understood! Your skin barrier needs deep hydration and soothing repair.`,"Loss of firmness or elasticity":`Makes sense! Your skin needs collagen support and lifting care.`},Fl={"Visible pores or excess oil":`Pore Tightening Ampoule`,"Dullness or uneven texture":`Turnover Ampoule`,"Dryness, tightness or irritation":`Moisture Treatment Ampoule`,"Loss of firmness or elasticity":`Dual Effect Ampoule`},Il=[`Refined pores and smoother-looking skin`,`Brighter, more even-looking skin`,`Deep hydration and lasting comfort`,`Firmer, bouncier-looking skin`],Ll=`What results are you looking for?`,Rl=`What skin concern are you noticing most lately?`;function zl({text:e}){if(!e.startsWith(`What skin concern are you noticing `))return e;let t=e.slice(0,Math.min(e.length,17)),n=e.slice(17,Math.min(e.length,35)),r=e.slice(35);return(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(`span`,{className:`v2-question-emphasis`,children:t}),n,e.length>35&&(0,Z.jsx)(`br`,{}),r]})}function Bl({text:e,prefix:t}){if(!e.startsWith(t))return e;let n=e.slice(0,Math.min(e.length,t.length)),r=e.slice(t.length);return(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(`span`,{className:`v2-question-emphasis`,children:n}),r]})}function Vl({skinType:e,answerOrigin:t,onBack:n,onNext:r}){let[i,a]=(0,_.useState)(null),o=Pl[e]||`Got it!`,s=(0,_.useRef)({}),[c,l]=(0,_.useState)(!t),[u,d]=(0,_.useState)(!t),[f,p]=(0,_.useState)(``),[m,h]=(0,_.useState)(!1),[g,v]=(0,_.useState)(``),[y,b]=(0,_.useState)(0),x=f.length>=o.length,S=g.length>=47;return(0,_.useEffect)(()=>{l(!1),d(!1);let e=setTimeout(()=>l(!0),t?760:0),n=setTimeout(()=>d(!0),t?1040:220);return()=>{clearTimeout(e),clearTimeout(n)}},[t,e]),(0,_.useEffect)(()=>{if(!u||x)return;let e=setTimeout(()=>{p(o.slice(0,f.length+1))},36);return()=>clearTimeout(e)},[u,f,o,x]),(0,_.useEffect)(()=>{if(!x)return;let e=setTimeout(()=>h(!0),400);return()=>clearTimeout(e)},[x]),(0,_.useEffect)(()=>{if(!m||S)return;let e=setTimeout(()=>{v(Rl.slice(0,g.length+1))},36);return()=>clearTimeout(e)},[m,g,S]),(0,_.useEffect)(()=>{if(!S)return;let e=Q.map((e,t)=>setTimeout(()=>b(t+1),300+t*140));return()=>e.forEach(clearTimeout)},[S]),(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(bl,{chat:!0,origin:`center`}),(0,Z.jsx)(Ol,{onBack:n}),(0,Z.jsx)(`div`,{className:`v2-deco v2-deco-left`,children:(0,Z.jsx)(`img`,{src:gl,alt:``})}),(0,Z.jsx)(`div`,{className:`v2-deco v2-deco-right`,children:(0,Z.jsx)(`img`,{src:gl,alt:``,style:{transform:`scaleX(-1)`}})}),c&&(0,Z.jsx)(`div`,{className:`v2-chat-blob-wrap v2-survey-followup-blob v2-followup-content-in`,children:(0,Z.jsx)(xl,{alt:`REJURAN character`})}),(0,Z.jsx)(wl,{origin:t,children:e}),u&&(0,Z.jsxs)(`div`,{className:`v2-bubble v2-bubble-answer v2-survey-followup-answer v2-followup-content-in`,children:[(0,Z.jsxs)(`span`,{children:[f,!x&&(0,Z.jsx)(`span`,{className:`v2-cursor`})]}),m&&(0,Z.jsxs)(`span`,{className:`v2-followup-question`,children:[(0,Z.jsx)(zl,{text:g}),!S&&(0,Z.jsx)(`span`,{className:`v2-cursor`}),S&&(0,Z.jsx)(`span`,{className:`v2-q-hint v2-followup-q-hint`,children:`SELECT ONLY 1`})]})]}),(0,Z.jsx)(`div`,{className:`v2-quiz-grid v2-concern-grid`,children:Q.map((e,t)=>(0,Z.jsxs)(`button`,{ref:t=>{s.current[e]=t},type:`button`,className:`v2-quiz-opt${i===e?` v2-quiz-opt-selected`:``}${y>t?` v2-quiz-opt-visible`:``}`,onClick:()=>a(e),children:[(0,Z.jsx)(`span`,{className:`v2-quiz-radio${i===e?` v2-quiz-radio-on`:``}`}),(0,Z.jsx)(`span`,{children:e})]},e))}),y>=Q.length&&(0,Z.jsxs)(`div`,{className:`v2-quiz-actions`,children:[(0,Z.jsx)(`button`,{type:`button`,className:`v2-back-btn`,onClick:n,children:`Back`}),(0,Z.jsx)(`button`,{type:`button`,disabled:!i,className:`v2-card-next-btn${i?` v2-card-next-btn-active`:``}`,onClick:()=>i&&r(i,Cl(s.current[i])),children:`Next →`})]}),(0,Z.jsx)(`div`,{className:`v2-logo-wrap`,children:(0,Z.jsx)(`img`,{src:dl,alt:`REJURAN COSMETICS`,className:`v2-logo`})})]})}function Hl({onDone:e}){return(0,_.useEffect)(()=>{let t=setTimeout(e,7600);return()=>clearTimeout(t)},[e]),(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(bl,{origin:`analyzing`}),(0,Z.jsx)(Ol,{onBack:null}),(0,Z.jsxs)(`div`,{className:`v2-analyzing-dots`,children:[(0,Z.jsx)(`span`,{className:`v2-dot`}),(0,Z.jsx)(`span`,{className:`v2-dot`}),(0,Z.jsx)(`span`,{className:`v2-dot`})]}),(0,Z.jsx)(`div`,{className:`v2-analyzing-blob`,children:(0,Z.jsx)(xl,{alt:`REJURAN character`})}),(0,Z.jsx)(`div`,{className:`v2-loading-card-stage`,"aria-hidden":`true`,children:[1,2,3,4].map(e=>(0,Z.jsx)(`img`,{src:`/loading-card0${e}.png`,alt:``,className:`v2-loading-card v2-loading-card-${e}`},e))}),(0,Z.jsx)(`div`,{className:`v2-card-wave-focus`,"aria-hidden":`true`}),(0,Z.jsxs)(`div`,{className:`v2-analyzing-text`,children:[(0,Z.jsx)(`p`,{className:`v2-analyzing-title`,children:`Perfect!`}),(0,Z.jsxs)(`p`,{className:`v2-analyzing-body`,children:[`I’ll find your best match`,(0,Z.jsx)(`br`,{}),`based on your answers.`]})]}),(0,Z.jsx)(`div`,{className:`v2-logo-wrap`,children:(0,Z.jsx)(`img`,{src:dl,alt:`REJURAN COSMETICS`,className:`v2-logo`})})]})}function Ul({concern:e,answerOrigin:t,onBack:n,onNext:r}){let[i,a]=(0,_.useState)(null),o=$[e]||`Noted!`,[s,c]=(0,_.useState)(!t),[l,u]=(0,_.useState)(!t),[d,f]=(0,_.useState)(``),[p,m]=(0,_.useState)(!1),[h,g]=(0,_.useState)(``),[v,y]=(0,_.useState)(0),b=d.length>=o.length,x=h.length>=33;return(0,_.useEffect)(()=>{c(!1),u(!1);let e=setTimeout(()=>c(!0),t?760:0),n=setTimeout(()=>u(!0),t?1040:220);return()=>{clearTimeout(e),clearTimeout(n)}},[t,e]),(0,_.useEffect)(()=>{if(!l||b)return;let e=setTimeout(()=>f(o.slice(0,d.length+1)),36);return()=>clearTimeout(e)},[l,d,o,b]),(0,_.useEffect)(()=>{if(!b)return;let e=setTimeout(()=>m(!0),400);return()=>clearTimeout(e)},[b]),(0,_.useEffect)(()=>{if(!p||x)return;let e=setTimeout(()=>g(Ll.slice(0,h.length+1)),36);return()=>clearTimeout(e)},[p,h,x]),(0,_.useEffect)(()=>{if(!x)return;let e=Il.map((e,t)=>setTimeout(()=>y(t+1),300+t*140));return()=>e.forEach(clearTimeout)},[x]),(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(bl,{chat:!0,origin:`center`}),(0,Z.jsx)(Ol,{onBack:n}),(0,Z.jsx)(`div`,{className:`v2-deco v2-deco-left`,children:(0,Z.jsx)(`img`,{src:gl,alt:``})}),(0,Z.jsx)(`div`,{className:`v2-deco v2-deco-right`,children:(0,Z.jsx)(`img`,{src:gl,alt:``,style:{transform:`scaleX(-1)`}})}),s&&(0,Z.jsx)(`div`,{className:`v2-chat-blob-wrap v2-survey-followup-blob v2-followup-content-in`,children:(0,Z.jsx)(xl,{alt:`REJURAN character`})}),(0,Z.jsx)(wl,{origin:t,children:e}),l&&(0,Z.jsxs)(`div`,{className:`v2-bubble v2-bubble-answer v2-survey-followup-answer v2-followup-content-in`,children:[(0,Z.jsxs)(`span`,{children:[d,!b&&(0,Z.jsx)(`span`,{className:`v2-cursor`})]}),p&&(0,Z.jsxs)(`span`,{className:`v2-followup-question`,children:[(0,Z.jsx)(Bl,{text:h,prefix:`What results`}),!x&&(0,Z.jsx)(`span`,{className:`v2-cursor`}),x&&(0,Z.jsx)(`span`,{className:`v2-q-hint v2-followup-q-hint`,children:`SELECT ONLY 1`})]})]}),(0,Z.jsx)(`div`,{className:`v2-quiz-grid v2-concern-grid v2-results-grid`,children:Il.map((e,t)=>(0,Z.jsxs)(`button`,{type:`button`,className:`v2-quiz-opt${i===e?` v2-quiz-opt-selected`:``}${v>t?` v2-quiz-opt-visible`:``}`,onClick:()=>a(e),children:[(0,Z.jsx)(`span`,{className:`v2-quiz-radio${i===e?` v2-quiz-radio-on`:``}`}),(0,Z.jsx)(`span`,{children:e})]},e))}),v>=Il.length&&(0,Z.jsxs)(`div`,{className:`v2-quiz-actions`,children:[(0,Z.jsx)(`button`,{type:`button`,className:`v2-back-btn`,onClick:n,children:`Back`}),(0,Z.jsx)(`button`,{type:`button`,disabled:!i,className:`v2-card-next-btn${i?` v2-card-next-btn-active`:``}`,onClick:()=>i&&r(i),children:`Next →`})]}),(0,Z.jsx)(`div`,{className:`v2-logo-wrap`,children:(0,Z.jsx)(`img`,{src:dl,alt:`REJURAN COSMETICS`,className:`v2-logo`})})]})}function Wl({onNavigate:e,onResult:t}){return(0,Z.jsxs)(`section`,{className:`v2-home-screen`,children:[(0,Z.jsx)(bl,{origin:`home`}),(0,Z.jsx)(Ol,{}),(0,Z.jsx)(`div`,{className:`dev-shortcuts`,children:[[`1`,`Turnover Ampoule`],[`2`,`Dual Effect Ampoule`],[`3`,`Pore Tightening Ampoule`],[`4`,`Moisture Treatment Ampoule`]].map(([e,n])=>(0,Z.jsx)(`button`,{className:`dev-shortcut-btn`,onClick:()=>t(n),children:e},e))}),(0,Z.jsx)(`div`,{className:`v2-blob-wrap`,children:(0,Z.jsx)(Sl,{className:`v2-blob`,alt:`REJURAN character`})}),(0,Z.jsxs)(`div`,{className:`v2-greeting`,children:[(0,Z.jsx)(`p`,{className:`v2-greeting-line v2-greeting-line-1`,children:`Hi!`}),(0,Z.jsx)(`p`,{className:`v2-greeting-line v2-greeting-line-2`,children:`How's it going?`})]}),(0,Z.jsx)(`div`,{className:`v2-suggestions`,children:Tl.map(t=>(0,Z.jsxs)(`button`,{type:`button`,className:`v2-suggestion-item`,onClick:()=>t.screen&&e(t.screen),children:[(0,Z.jsx)(`img`,{src:t.icon,alt:``,className:`v2-suggestion-icon`}),(0,Z.jsx)(`span`,{className:`v2-suggestion-text`,children:t.text})]},t.text))}),(0,Z.jsx)(`img`,{src:`/bar.png`,alt:`input bar`,className:`v2-input-bar-img`}),(0,Z.jsx)(`div`,{className:`v2-logo-wrap`,children:(0,Z.jsx)(`img`,{src:dl,alt:`REJURAN COSMETICS`,className:`v2-logo`})})]})}var Gl={"Turnover Ampoule":{name:`TURNOVER AMPOULE`,resultClass:`rs-turnover`,image:`/turnover02.png`,descLines:[`A youthful glow with c-PDRN®, a marine-based`,`growth factor that helps improve the appearance of`,`skin's tone, texture, and radiance.`],waveX:`558px`,waveY:`800px`,nextLabel:`Next`,lifestyle:`/turnover01.png`},"Dual Effect Ampoule":{name:`DUAL EFFECT AMPOULE`,resultClass:`rs-dual-effect`,image:`/dualeffect02.png`,descLines:[`Firmer, smoother-looking skin with c-PDRN®,`,`an advanced skin-renewing ingredient that helps`,`improve elasticity, texture, and overall radiance.`],waveX:`564px`,waveY:`770px`,nextLabel:`Next`,lifestyle:`/dualeffect01.png`},"Pore Tightening Ampoule":{name:`PORE TIGHTENING AMPOULE`,nameLines:[`PORE TIGHTENING`,`AMPOULE`],resultClass:`rs-pore`,image:`/pore02.png`,descLines:[`Refine the look of pores and achieve`,`a smoother, more balanced complexion with`,`Pore Tightening Ampoule.`],waveX:`572px`,waveY:`800px`,nextLabel:`Next`,lifestyle:`/pore01-1.png`},"Moisture Treatment Ampoule":{name:`MOISTURE TREATMENT AMPOULE`,resultClass:`rs-moisture`,image:`/moisture02.png`,descLines:[`Restore calm, deeply hydrated skin with`,`Moisture Treatment Ampoule, a soothing serum`,`designed to support the skin barrier.`],waveX:`564px`,waveY:`800px`,nextLabel:`Next`,lifestyle:`/moisture01-1.png`}};function Kl({product:e,onRestart:t,onNext:n}){let r=Gl[e]||Gl[`Turnover Ampoule`],[i,a]=(0,_.useState)(!1);return(0,_.useEffect)(()=>{a(!1)},[e]),(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(bl,{origin:`result`,style:{"--wave-x":r.waveX,"--wave-y":r.waveY}}),(0,Z.jsxs)(`section`,{className:`rs-page ${r.resultClass}`,children:[(0,Z.jsx)(Ol,{onBack:null}),(0,Z.jsx)(`div`,{className:`rs-result-scroll`,onScroll:e=>a(e.currentTarget.scrollTop>1),children:(0,Z.jsxs)(`div`,{className:`rs-result-scroll-inner`,children:[(0,Z.jsx)(`div`,{className:`rs-blob-clip`,children:(0,Z.jsx)(xl,{})}),(0,Z.jsx)(`div`,{className:`rs-speech-wrap`,children:(0,Z.jsx)(`span`,{className:`rs-speech-text`,children:`Here's your match!`})}),(0,Z.jsx)(`div`,{className:`rs-product-area`,children:(0,Z.jsx)(`img`,{src:r.image,alt:r.name,className:`rs-product-img`})}),(0,Z.jsx)(`p`,{className:`rs-product-name`,children:r.nameLines?r.nameLines.map((e,t)=>(0,Z.jsxs)(`span`,{children:[e,t<r.nameLines.length-1&&(0,Z.jsx)(`br`,{})]},e)):r.name}),(0,Z.jsx)(`p`,{className:`rs-product-desc`,children:r.descLines?r.descLines.map((e,t)=>(0,Z.jsxs)(`span`,{children:[e,t<r.descLines.length-1&&(0,Z.jsx)(`br`,{})]},e)):r.desc}),(0,Z.jsx)(`img`,{src:r.lifestyle,alt:``,className:`rs-lifestyle-img`}),(0,Z.jsx)(`button`,{className:`rs-next-btn`,onClick:n,children:r.nextLabel||`›`})]})}),(0,Z.jsxs)(`p`,{className:`rs-scroll-cue${i?` rs-scroll-cue-hidden`:``}`,children:[(0,Z.jsx)(`span`,{className:`rs-scroll-cue-text`,children:`Scroll down`}),(0,Z.jsx)(`span`,{className:`rs-scroll-cue-arrow`,"aria-hidden":`true`,children:`↓`})]}),(0,Z.jsx)(`div`,{className:`v2-logo-wrap`,children:(0,Z.jsx)(`img`,{src:dl,alt:`REJURAN COSMETICS`,className:`v2-logo`})})]})]})}function ql({onHome:e}){return(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(bl,{origin:`goodbye`}),(0,Z.jsx)(Ol,{onBack:null}),(0,Z.jsx)(`div`,{className:`gb-blob-wrap`,children:(0,Z.jsx)(xl,{})}),(0,Z.jsx)(`p`,{className:`gb-line1`,children:`Thanks for coming!`}),(0,Z.jsx)(`p`,{className:`gb-line2`,children:`Enjoy!`}),(0,Z.jsx)(`button`,{className:`gb-btn`,onClick:e,children:`Goodbye!`}),(0,Z.jsx)(`div`,{className:`v2-logo-wrap`,children:(0,Z.jsx)(`img`,{src:dl,alt:`REJURAN COSMETICS`,className:`v2-logo`})})]})}function Jl(){let[e,t]=(0,_.useState)(`home`),[n,r]=(0,_.useState)(``),[i,a]=(0,_.useState)(``),[o,s]=(0,_.useState)(``),[c,l]=(0,_.useState)([]),[u,d]=(0,_.useState)(null),[f,p]=(0,_.useState)(null),[m,h]=(0,_.useState)(`great`),g=e===`great`||e===`quiz1`;return(0,_.useEffect)(()=>{e!==`pdrn`&&e!==`pdrn2`||l(t=>t.includes(e)?t:[...t,e])},[e]),(0,Z.jsx)(`main`,{className:`app app-v2`,children:(0,Z.jsxs)(`div`,{className:`portrait-layout`,children:[e===`home`&&(0,Z.jsx)(Wl,{onNavigate:t,onResult:e=>{s(e),t(`result`)}}),e===`pdrn`&&(0,Z.jsx)(kl,{variant:`pdrn`,question:`What is PDRN?`,answer:El,onBack:()=>t(`home`),onNext:()=>t(`great`),recommendation:c.includes(`pdrn2`)?null:{question:`What makes REJURAN's PDRN different from other brands?`,onYes:()=>t(`pdrn2`)}}),e===`pdrn2`&&(0,Z.jsx)(kl,{variant:`pdrn-diff`,question:`What makes REJURAN's PDRN different?`,answer:Dl,onBack:()=>t(`home`),onNext:()=>t(`great`),recommendation:c.includes(`pdrn`)?null:{question:`What is PDRN?`,onYes:()=>t(`pdrn`)}}),e===`great`&&(0,Z.jsx)(Al,{onOk:()=>{t(`quiz1`),requestAnimationFrame(()=>{requestAnimationFrame(()=>h(`quiz1`))})}}),e===`quiz1`&&(0,Z.jsx)(Nl,{onBack:()=>{h(`great`),requestAnimationFrame(()=>{requestAnimationFrame(()=>t(`great`))})},onNext:(e,n)=>{r(e),d(n),t(`quiz2`)}}),e===`quiz2`&&(0,Z.jsx)(Vl,{skinType:n,answerOrigin:u,onBack:()=>t(`quiz1`),onNext:(e,n)=>{a(e),p(n),s(Fl[e]||``),t(`quiz3`)}}),e===`quiz3`&&(0,Z.jsx)(Ul,{concern:i,answerOrigin:f,onBack:()=>t(`quiz2`),onNext:()=>t(`analyzing`)}),e===`analyzing`&&(0,Z.jsx)(Hl,{onDone:()=>t(`result`)}),e===`result`&&(0,Z.jsx)(Kl,{product:o,onRestart:()=>t(`home`),onNext:()=>t(`goodbye`)}),e===`goodbye`&&(0,Z.jsx)(ql,{onHome:()=>t(`home`)}),g&&(0,Z.jsx)(xl,{className:`v2-shared-blob v2-shared-blob--${m}`})]})})}v.createRoot(document.getElementById(`root`)).render((0,Z.jsx)(_.StrictMode,{children:(0,Z.jsx)(Jl,{})}));